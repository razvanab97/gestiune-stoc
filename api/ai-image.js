// Poze de produs recreate cu AI — un singur fișier, ramificat pe metodă HTTP (consolidare pentru
// limita de 12 Serverless Functions pe planul Vercel Hobby — vezi vercel.json):
//   POST -> recreează/îmbunătățește o poză existentă cu AI (fundal curat, prezentare profesională de
//           tip e-commerce), PORNIND de la poza reală a produsului (image edit, nu generare din
//           imaginație, tocmai ca să nu inventăm cum arată produsul). Rezultatul se salvează în ai_images.
//   GET  -> servește o imagine deja generată (stocată base64), ca URL public stabil — necesar ca poza
//           să poată fi folosită direct în exportul XLSX/ghidul eMAG (care au nevoie de un URL http(s)
//           real, nu de un data: URI).
